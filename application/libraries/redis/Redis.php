...
//require_once APPPATH . 'libraries/redis/vendor/autoload.php';
require_once APPPATH . 'libraries/redis/RedisServer.php';
require_once APPPATH . 'libraries/redis/RedisServerCollection.php';
